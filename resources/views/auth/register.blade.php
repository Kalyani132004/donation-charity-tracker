...
<div class="auth-page-center">
    ...
    <div class="auth-card">
        ...
        <h4 class="auth-card-title">Create Your Account</h4>
        <p class="auth-card-subtitle">Join KindTrack and make a difference</p>
        ...
        <form action="{{ route('register.attempt') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter your full name" class="form-control @error('name') is-invalid @enderror" required autofocus>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-group">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" class="form-control @error('email') is-invalid @enderror" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-group">
                    ...
                    <input type="password" name="password" id="passwordField" placeholder="Enter your password" class="form-control @error('password') is-invalid @enderror" required>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-group">
                    <i class="bi bi-lock"></i>
                    <input type="password" name="password_confirmation" id="passwordConfirmField" placeholder="Confirm your password" class="form-control" required>
                    <button type="button" class="input-icon-toggle" data-toggle-password="passwordConfirmField">
                        <i class="bi bi-eye"></i>
                    </button>
                </div>
            </div>
        ...
        <p class="auth-note"><i class="bi bi-info-circle"></i> New accounts get Staff access by default.</p>
    </div>
